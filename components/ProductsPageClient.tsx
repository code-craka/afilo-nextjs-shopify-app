...
interface ProductsPageClientProps {
  ...
  initialSortBy: 'title' | 'price' | 'createdAt' | 'updatedAt';
...
export default function ProductsPageClient({
  ...
  const updateFilters = useCallback((newSearch?: string, newSortBy?: typeof sortBy, newSortOrder?: typeof sortOrder) => {
  ...
  }, [searchQuery, initialSearchQuery, updateFilters]);
